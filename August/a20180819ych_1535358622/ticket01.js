...
//////////////////////////////////////////////////////////////////////////////////////////
function LimitInfo(){
    var sUrl="//apps.game.qq.com/cgi-bin/daoju/v3/api/hs/plug_ticket/tuan_goods_limit.cgi?_app_id=1004&_output_fmt=2&_biz_code=mgc&_act_id=59&propid="+ticketType+Math.random();
...
function BuyTicket(){
    ...
    var sUrl = "//apps.game.qq.com/cgi-bin/daoju/v3/hs/i_buy.cgi?_app_id=1004&_plug_id=9200&_biz_code=mgc&_act_id=59&propid="+ticketType+"&buynum="+$('#TicketNum').val()+"&areaid="+areaId+"&r="+Math.random()+"&roleid="+LoginManager.getUserUin()+"&getUid="+$('#TicketPresent').val()+"&rolename=";
    console.log(sUrl);
